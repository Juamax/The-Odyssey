...
from odiseo_vs_ciclope.config   import W, H, FPS, FLOOR_Y, BLACK, WHITE, RED, GOLD, GRAY
from odiseo_vs_ciclope.utils    import load_gif_frames, Amphora
from odiseo_vs_ciclope.entities import Player, Cyclops, Soldier
from odiseo_vs_ciclope.ui       import draw_hud, draw_overlay_screen, show_victory_sequence
...
def main():
    ...
    # ── Cargar assets ─────────────────────────────────────────
    odiseo_frames  = load_gif_frames("odiseo_vs_ciclope/odiseo.gif",  scale=(75,  90))
    ciclope_frames = load_gif_frames("odiseo_vs_ciclope/ciclope.gif", scale=(220, 300))
    soldier_frames = [
        load_gif_frames("odiseo_vs_ciclope/soldado.png", scale=(75, 90)),
        load_gif_frames("odiseo_vs_ciclope/soldado.png", scale=(75, 90)),
    ]
    ...
    bg        = load_img("odiseo_vs_ciclope/cueva.jpg",                (20, 12, 30))
    img_vence = load_img("odiseo_vs_ciclope/odiseo_vence_ciclope.PNG", (50, 20, 10))
    img_escapa= load_img("odiseo_vs_ciclope/odiseo_escapa_cueva.PNG",  (10, 30, 60))
    try: bg = pygame.transform.scale(pygame.image.load("odiseo_vs_ciclope/cueva.jpg").convert(), (W, H))
    except: pass
    ...
    while True:
        ...
        # ── Resultado ─────────────────────────────────────────
        if result == "win":
            show_victory_sequence(screen, clock, font_big, font_med, img_vence, img_escapa)
            return  # ← termina la función y regresa a historia.py
            ...
            while waiting:
                ...
                for ev in pygame.event.get():
                    ...
                    if ev.type == pygame.KEYDOWN:
                        ...
                        if ev.key == pygame.K_ESCAPE: return  # ← termina y regresa
