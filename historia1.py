...
class NovelVisual:
    def __init__(self):
        ...
        if os.path.exists("sprites/fondo_musica.mp3"):
            pygame.mixer.music.load("sprites/fondo_musica.mp3")
    ...
    def _construir_escenas(self):
        ...
        return [
            ...
            {"tipo": "minijuego", "nombre": "tormenta"},
            ...
            {"tipo": "minijuego", "nombre": "inframundo"},
            ...
            {"tipo": "minijuego", "nombre": "atenea_vs_zeus"},
            ...
            {"tipo": "minijuego", "nombre": "pretendientes"},
    ...
    def _setup(self, esc):
        ...
        if t == "minijuego":
            nombre = esc["nombre"]
            if nombre == "ciclope":
                from odiseo_vs_ciclope.main import main
                main()
            elif nombre == "tormenta":
                from Minijuego_Poseidon.mnposeidon2 import MiniJuego1
                MiniJuego1().jugar()
            elif nombre == "circe":
                from minijuegos.mncirce import MiniJuego1 as MiniJuegoCirce
                MiniJuegoCirce().jugar()
            elif nombre == "inframundo":
                from minijuegos.minijuego1 import ejecutar_minijuego1
                ejecutar_minijuego1()
            elif nombre == "atenea_vs_zeus":
                from Minijuego_Zeus.mnzeus import MiniJuego1 as MiniJuegoZeus
                MiniJuegoZeus().jugar()
            elif nombre == "pretendientes":
                from Batalla_final.minijuego5 import ejecutar_minijuego1 as ejecutar_pretendientes
                ejecutar_pretendientes()
            return "skip"
        return "skip"
