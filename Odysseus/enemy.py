import pygame
import random
from Odysseus.entidad import Entidad
...
class Enemy(Entidad):
    ...
    def __init__(self, x, y, vida, velocidad):
        ...
        #Animaciones 
        self.move_frames = self.cargar_frames ("Odysseus/animacion/enemigo1/enemigo1_moverse.png")
        self.atacar_frames = self.cargar_frames ("Odysseus/animacion/enemigo1/enemigo1_atacar.png")
        self.muerte_frames = self.cargar_frames ("Odysseus/animacion/enemigo1/enemigo1_muerte.png")
...
class Enemy2 (Enemy):
    def __init__(self, x, y, vida, velocidad):
        ...
        #Animaciones 
        self.move_frames = self.cargar_frames ("Odysseus/animacion/enemigo2/enemigo2_mover.png")
        self.atacar_frames = self.cargar_frames ("Odysseus/animacion/enemigo2/enemigo2_atacar.png")
        self.muerte_frames = self.cargar_frames ("Odysseus/animacion/enemigo2/enemigo2_muerte.png")
